...
int makeMatrix(int argc, char *argv[])      { PAFL::Pipeline(argc, argv).makeMatrix("/home/donguk/aeneas/manybugs"); return 0; }
...
{
    return testTokenTreeCpp("/4tb/donguk/bugscpp/libchewing/buggy-6/src/chewingutil.c");
